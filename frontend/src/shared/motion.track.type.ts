...
export type HapticsTrack = z.infer<typeof hapticsTrackSchema>;
export const hapticsTrackSchema = z.object({
  program: z.string(),
  hapticsList: z.array(
    z.object({
...
export type GestureTrack = z.infer<typeof gestureTrackSchema>;
...
export type JediConfig = z.infer<typeof jediConfigSchema>;
export const jediConfigSchema = z.object({
  start_live: z.string(),
  stop: z.string(),
